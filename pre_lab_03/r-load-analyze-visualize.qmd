...
```
      770,000 for a senior photo editor at Tribune Publishing
...
HighestPaidDetails <- NewYorkTimes %>% filter(Salary== 350000)
...
#The Median is 50,350 which is a little less than 2,000 less than the median salary of an employee at the New York Times.
