...
#Answer 1: If I wanted to relate this back to the topic of my first project, I could use a spaital join (st_join) to connect the Census tracts of the neighborhoods in Baltimore and find out if on average people who live in lower or higher income Census tracts live in areas with more or less street light outages. I would use the BNIA street light outage per 1,000 residents data and either the median income or per capita income in these neighborhoods.

#Answer 2: I could also use a spatial join (st_join) to connect the Census tracts of the neighborhoods in Baltimore and find out if neighborhoods with a higher median income have a higher or lower percentage of the population that uses public transportation to get to work and I would likely say that anything over 50% would be considered an area with more public transportation use and anything less would be classified as less public transportation use. This could be used by downloading and loading the percent of population that uses public transportation to get to work and I would likely want to use the per capita income data for this because it would be a better representation of the income of the people that take public transportation to get to work. 
