...
It's not super pretty, but there's an obvious pattern, a big peak in 2017.
...
arrest %>% 
  ggplot() +
  geom_bar(aes(x=reorder(year, n), weight=n, fill = n)) + 
   labs(title = "Arrest Totals Per Year", 
       subtitle = "SF PD Service Call Data, 2016-2019",
...
all_dispo %>% 
  ...
  geom_bar(aes(x=reorder(disposition, n), weight=n, fill = n)) +
    labs(title = "Most Common Resolutions for 311 Calls ", 
       subtitle = "SF PD Service Call Data, 2016-2019",
       caption = "Graphic by Parker Leipzig",
       y="Frequency",
       x="Most Common Resolutions")
