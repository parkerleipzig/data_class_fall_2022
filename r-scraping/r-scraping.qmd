...
#Answer: One question that I could answer using this table of votes and the American Community Survey is using the demographic data per county regarding race and finding the percentage of each race per Maryland county and then comparing and seeing who of these candidates did counties with the highest white population vote for, who did counties with the highest Black population work for, highes hispanic population, etc.
#Answer 2: Another question that could be answered using the American Community Survey is using the age demographics and finding out if counties with larger young voter populations voted more or less in the election than counties with older voter populations. 
