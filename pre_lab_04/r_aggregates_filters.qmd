...
Tweet: About 48.5% of census tracts in Baltimore City had a household income below the median income for the city in 2020. Census tract 1702, which encompasses Upton/Druid Heights, had the lowest income in 2020 at $13,559. The median income in Baltimore City that year was $49,875.


```{r}
census_below_median <- baltcity_income %>%
  select(Census, x2020) %>% 
  filter(x2020 < 49875) %>% 
  arrange(x2020)
